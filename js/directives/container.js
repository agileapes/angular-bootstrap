(function (toolkit) {
    toolkit.dynamic.container = new toolkit.classes.Directive("1.0", "container", function () {
        return {
            restrict: "E",
            replace: true,
            transclude: true,
            templateUrl: toolkit.dynamic.container.templateUrl,
            scope: {
                type: "@",
                stacked: "@"
            },
    ...
    toolkit.dynamic.section = new toolkit.classes.Directive("1.0", "section", function () {
        return {
            require: '^' + toolkit.classes.Directive.qualify("container"),
            restrict: 'E',
            transclude: true,
            replace: true,
            templateUrl: toolkit.dynamic.section.templateUrl,
            scope: {
                title: "@",
                active: "@",
                glyph: "@"
